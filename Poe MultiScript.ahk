...
Gui, Show, x760 y198 h525 w474, PoE MultiScript v03.13.2014
...
ReadPlayerStats(hwnd, byRef PlayerStats)
{
   ...
   PlayerActionID:=ReadMemUInt(pH,PlayerMain+0x1C)
   PlayerStats.PlayerActionID:=ReadMemUInt(pH,PlayerActionID+0x9C)
   if (Steam)
   {
   ...
   Panels1Offset:=GetMultilevelPointer(pH,[CheckBase+0x44,0x788,0x1DC])
   PlayerStats.Panels1:=ReadMemUInt(pH,Panels1Offset+0x860)
   Panels2Offset:=GetMultilevelPointer(pH,[CheckBase+0x40,0x788,0x1DC])
   PlayerStats.Panels2:=ReadMemUInt(pH,Panels2Offset+0x860)
...
Main()
{
   ...
   Loop, %WinID%
   {
      ...
      if (PlayerStats.PlayerActionID!="" && PlayerStats.PlayerActionID!=2176 && PlayerStats.PlayerActionID!=2192 && PlayerStats.PlayerActionID!=128 && PlayerStats.PlayerActionID!=144)
      {
      ...
      if(QuickSilverCheck)
      {
         if (PlayerStats.InCity!="" && PlayerStats.InCity=65537)
         {
            ...
            {
               If (PlayerStats.Panels1!="" && PlayerStats.Panels1=65537)
               {
                  If (PlayerStats.Panels2!="" && PlayerStats.Panels2=65537)
                  {
                     if (PlayerStats.PlayerActionID!="" && (PlayerStats.PlayerActionID=2176 || PlayerStats.PlayerActionID=2192 || PlayerStats.PlayerActionID=128 || PlayerStats.PlayerActionID=144))
                     {
